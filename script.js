...
function calcular() {
    ...
    if(option == "#") {
        ...
        Ao não utilizar nossos processos de controle, você tem lucro final de café tipo ${tipo} de R$${Total.toFixed(2).replace(".", ",")}
        <br><br>
        ...
        Com nossos serviços de controle de qualidade no processo de armazenamento, há uma diminuição percentual de 20% da quantidade de quilos perdidos, totalizando um aumento de até 20% de lucro para sua empresa.
        <br><br><br>
...
=======
    ...
    <br><br>
    <span class="update">Valores atualizados em 20/03/2024</span>`;
>>>>>>> d238d0adf9f92f49c2d2fe8514397a37f81c1dfb
}
